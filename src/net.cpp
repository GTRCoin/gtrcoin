...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "GTRcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"gtrcointools.com", "119.205.233.188"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"gtrcointools.com", "testnet-seed.gtrcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. GTRcoin is probably already running."), addrBind.ToString().c_str());
        else
